...
public class FlightSolver {
    ...
    public FlightSolver(ArrayList<Flight> flights) {
        /* FIX ME */
        PriorityQueue<Flight> startMinPQ = new PriorityQueue<Flight>
                ((Flight o1, Flight o2) -> {return o1.startTime() - o2.startTime();});
        /**
        ...
        PriorityQueue<Flight> endMinPQ = new PriorityQueue<>
                ((Flight o1, Flight o2) -> {return o1.endTime() - o2.endTime();});
