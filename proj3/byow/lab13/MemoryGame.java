...
public class MemoryGame {
    ...
    public MemoryGame(int width, int height, long seed) {
        ...
        //TODO: Initialize random number generator  done!
        rand = new Random(seed);
    }

    public String generateRandomString(int n) {
        //TODO: Generate random string of letters of length n   done!
        String randomString = "";
        for( int i = 0; i < n; i++){
            randomString += CHARACTERS[rand.nextInt(26)];
        }
        return randomString;
    }
    ...
    public void flashSequence(String letters) {
        ...
        for (int i = 0; i < letters.length(); i++){
            // drawFrame(letters.subString(i, i + 1); it is better.
