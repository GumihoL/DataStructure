...
/** I do not know why this nearest() can not work.
    private Node nearest(Node n, Point ref, Node best, double bestDist){
        // Traverse the whole tree
        if (n == null) return best;
        if (Point.distance(n.coordinate, ref) < bestDist){
            best = n;
            bestDist = Point.distance(best.coordinate, ref);
        }
        best = nearest(n.left, ref, best, bestDist);
        best = nearest(n.right, ref, best, bestDist);
        return best;
    }
 */
