...
public class Plip extends Creature {
    ...
    private int b;
    /**
     * the energy lost by move
     */
    private static final float moveEnergyLost = 0.15f;
    /**
     * the energy gain by stay
     */

    private static final float stayEnergyGet = 0.2f;
    /**
    ...
    public Color color() {
        ...
        r = 99;
        b = 76;
        return color(99, (int)(63 + energy *96), 76);
    }
     ...
     */
    public void stay() {
        if (energy + stayEnergyGet > 2){
            energy = 2;
        }
        else{
            energy += stayEnergyGet;
        }
    }
