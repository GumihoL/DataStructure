...
public class DemoRunSeveralPuzzles {
    private static String[] basicPuzzles = {"/bearmaps/hw4/input/BasicPuzzle1.txt", "/bearmaps/hw4/input/BasicPuzzle2.txt",
        "/bearmaps/hw4/input/BasicPuzzle3.txt", "/bearmaps/hw4/input/BasicPuzzle4.txt"};

    private static String[] hardPuzzles = {"/bearmaps/hw4/input/HardPuzzle1.txt", "/bearmaps/hw4/input/HardPuzzle2.txt",
        "/bearmaps/hw4/input/HardPuzzle3.txt"};

    private static String[] elitePuzzles = {"/bearmaps/hw4/input/ElitePuzzle1.txt", "/bearmaps/hw4/input/ElitePuzzle2.txt",
        "/bearmaps/hw4/input/ElitePuzzle3.txt"};
